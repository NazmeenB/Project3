...
st.title("\U0001F31E Solar Power Generation Prediction \U0001F31F")
...
st.sidebar.header("Input Features \U0001F4CA")
...
if st.button("🔮 Predict"):
    with st.spinner("✨ Calculating..."):
        try:
            ...
            st.info(f"Did you know? {np.random.choice(facts)} \U0001F31E")
...
st.markdown("""
---
Made with ❤️ by Team___________________________
""")
